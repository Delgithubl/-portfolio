...
const Header = () => {
  return (
    <div>
      <header className="flex justify-between px-4 mt-4  max-w-screen-xl w-full mx-auto ">
        <svg
          width="70"
          height="70"
          viewBox="0 0 406 368"
          ...
          className="z-40 hover:shadow-lg cursor-pointer hover:scale-105"
        >
          <path
      ...
      href="http://Wa.me/+917300733744">  <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="whatsapp"
            className="svg-inline--fa fa-whatsapp fa-w-14 z-40 cursor-pointer "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
